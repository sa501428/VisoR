...
public class VisorRenderer implements GLSurfaceView.Renderer{

	private HeadsetView cameraStreamLeft, cameraStreamRight;
	...
	public VisorRenderer(int[] images, CameraAdapter delegate, Context context){
	...
	public void onSurfaceCreated(GL10 unused, EGLConfig config){
		...
		cameraStreamLeft = new HeadsetView(DimensionVault.drawOrder, DimensionVault.triangleVerticesLeft, DimensionVault.textureVerticesLeft);
		cameraStreamRight = new HeadsetView(DimensionVault.drawOrder, DimensionVault.triangleVerticesRight, DimensionVault.textureVerticesRight);
