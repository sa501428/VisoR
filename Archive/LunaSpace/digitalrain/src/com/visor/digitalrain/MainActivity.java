...
public class MainActivity extends Activity implements SurfaceTexture.OnFrameAvailableListener{
	...
	private int[] images = {R.drawable.digitalwall22, R.drawable.digitalwall32,
			R.drawable.digitalwall42, R.drawable.digitalwall22r, R.drawable.digitalwall32r,
			R.drawable.digitalwall42r, R.drawable.digitalwall22v, R.drawable.digitalwall32v,
			R.drawable.digitalwall42v, R.drawable.digitalwall22rv, R.drawable.digitalwall32rv,
			R.drawable.digitalwall42rv};//, R.drawable.digitalwall5, R.drawable.digitalwall6};
	private int numImages = images.length;
	...
	private void setUpOverlayedViews() {
		...
		//rainText=new DigitalRainTextView(this); 
		//rainText.setLayoutParams(tParams);
/*		rainImage = new ImageView(this);
		rainImage.setLayoutParams(tParams);
		rainImage.setScaleType(ImageView.ScaleType.FIT_XY);
		rainImage.setImageResource(images[0]);
*/

		rLayout.addView(glSurfaceView);
		// rLayout.addView(rainImage);
