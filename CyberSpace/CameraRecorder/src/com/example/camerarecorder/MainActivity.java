package com.example.camerarecorder;
	...
	public class MainActivity extends Activity
	    ...
	    public static final String TAG = "My Camcorder";
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        File outputFile = new File(android.os.Environment.getExternalStorageDirectory().getAbsolutePath() + "/download", "camera-test.mp4");
