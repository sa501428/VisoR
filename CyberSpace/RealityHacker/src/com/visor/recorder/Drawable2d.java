...
public class Drawable2d {
    ...
    private static final FloatBuffer TRIANGLE_BUF =
            Recorder_GL_Toolbox.setupFloatBuffer(TRIANGLE_COORDS);
    private static final FloatBuffer TRIANGLE_TEX_BUF =
    		Recorder_GL_Toolbox.setupFloatBuffer(TRIANGLE_TEX_COORDS);
    ...
    private static final FloatBuffer RECTANGLE_BUF =
    		Recorder_GL_Toolbox.setupFloatBuffer(RECTANGLE_COORDS);
    private static final FloatBuffer RECTANGLE_TEX_BUF =
    		Recorder_GL_Toolbox.setupFloatBuffer(RECTANGLE_TEX_COORDS);
    ...
    private static final FloatBuffer FULL_RECTANGLE_BUF =
    		Recorder_GL_Toolbox.setupFloatBuffer(FULL_RECTANGLE_COORDS);
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF =
    		Recorder_GL_Toolbox.setupFloatBuffer(FULL_RECTANGLE_TEX_COORDS);
