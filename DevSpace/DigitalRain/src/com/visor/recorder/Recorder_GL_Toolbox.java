...
public class Recorder_GL_Toolbox {
	...
	public static int createProgram(String vertexShaderText, String fragmentShaderText) {
		int vertexShader = loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderText);
		int fragmentShader = loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderText);
