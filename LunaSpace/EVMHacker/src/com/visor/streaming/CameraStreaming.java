...
public class CameraStreaming {
	...
	public CameraStreaming(int texture,	float[] triangleVertices, float[] textureVertices) 
	{
		...
		//subTexture = MyRenderer.createTexture();
		...
		fragmentShader = MyRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, FilterVault.standard);
	...
	*/	
	...
	/*	
		...
		GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGBA, m_frame.width,
				m_frame.height, 0,  GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, camera_data);
